  ...
  const quickActions = [
    {
      ...
      icon: <EventIcon fontSize="large" sx={{ color: accentColor }} />,
      action: () => navigate("/book-consultation")
    },
    {
      title: "E-Pharmacy",
      icon: <LocalPharmacyIcon fontSize="large" sx={{ color: accentColor }} />,
      action: () => navigate("/epharmacy")
    },
    {
      title: "Dietetics",
      icon: <RestaurantIcon fontSize="large" sx={{ color: accentColor }} />,
      action: () => navigate("/dietetics")
    },
    {
      title: "Mental Health",
      icon: <PsychologyIcon fontSize="large" sx={{ color: accentColor }} />,
      action: () => navigate("/mental-health")
    },
    {
      title: "Herbal Medicine",
      icon: <SpaIcon fontSize="large" sx={{ color: accentColor }} />,
      action: () => navigate("/herbal")
    },
    {
      title: "AI Assistant",
      icon: <ChatIcon fontSize="large" sx={{ color: accentColor }} />,
      action: () => navigate("/ai")
    }
  ]
